import {$A, $S, Any, AnySync, Operation, UnionAny} from '../types';
 ...
 * @category Sync+Async
 */
export function concat<T, Vs extends unknown[]>(
    ...values: {
        [P in keyof Vs]: Any<Vs[P]>;
    }
): Operation<T, T | UnionAny<Vs>> {
    return createOperation(concatSync, concatAsync, values);
}
