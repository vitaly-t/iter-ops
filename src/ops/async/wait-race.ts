 ...
 * results in better concurrency. Setting it to less than 2 will deactivate caching+racing logic
 * completely, and instead apply the same logic as operator {@link wait}.
 *
 * @see
 *  - {@link wait}
 *
