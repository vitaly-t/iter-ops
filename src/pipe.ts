import {AsyncIterableExt, IterableExt, Piper} from './types';
...
export function pipe<T, A>(i: AsyncIterable<T>, p0: Piper<T, A>): AsyncIterableExt<A>;
export function pipe<T, A, B>(i: AsyncIterable<T>, p0: Piper<T, A>, p1: Piper<A, B>): AsyncIterableExt<B>;
export function pipe<T, A, B, C>(i: AsyncIterable<T>, p0: Piper<T, A>, p1: Piper<A, B>, p2: Piper<B, C>): AsyncIterableExt<C>;
export function pipe<T, A, B, C, D>(i: AsyncIterable<T>, p0: Piper<T, A>, p1: Piper<A, B>, p2: Piper<B, C>, p3: Piper<C, D>): AsyncIterableExt<D>;
export function pipe<T, A, B, C, D, E>(i: AsyncIterable<T>, p0: Piper<T, A>, p1: Piper<A, B>, p2: Piper<B, C>, p3: Piper<C, D>, p4: Piper<D, E>): AsyncIterableExt<E>;
export function pipe<T, A, B, C, D, E, F>(i: AsyncIterable<T>, p0: Piper<T, A>, p1: Piper<A, B>, p2: Piper<B, C>, p3: Piper<C, D>, p4: Piper<D, E>, p5: Piper<E, F>): AsyncIterableExt<F>;
export function pipe<T, A, B, C, D, E, F, G>(i: AsyncIterable<T>, p0: Piper<T, A>, p1: Piper<A, B>, p2: Piper<B, C>, p3: Piper<C, D>, p4: Piper<D, E>, p5: Piper<E, F>, p6: Piper<F, G>): AsyncIterableExt<G>;
export function pipe<T, A, B, C, D, E, F, G, H>(i: AsyncIterable<T>, p0: Piper<T, A>, p1: Piper<A, B>, p2: Piper<B, C>, p3: Piper<C, D>, p4: Piper<D, E>, p5: Piper<E, F>, p6: Piper<F, G>, p7: Piper<G, H>): AsyncIterableExt<H>;
export function pipe<T, A, B, C, D, E, F, G, H, I>(i: AsyncIterable<T>, p0: Piper<T, A>, p1: Piper<A, B>, p2: Piper<B, C>, p3: Piper<C, D>, p4: Piper<D, E>, p5: Piper<E, F>, p6: Piper<F, G>, p7: Piper<G, H>, p8: Piper<H, I>): AsyncIterableExt<I>;
export function pipe<T, A, B, C, D, E, F, G, H, I, J>(i: AsyncIterable<T>, p0: Piper<T, A>, p1: Piper<A, B>, p2: Piper<B, C>, p3: Piper<C, D>, p4: Piper<D, E>, p5: Piper<E, F>, p6: Piper<F, G>, p7: Piper<G, H>, p8: Piper<H, I>, p9: Piper<I, J>): AsyncIterableExt<J>;
