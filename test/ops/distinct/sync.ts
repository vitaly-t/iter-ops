...
import {pipeSync, distinct} from '../../../src';
...
export default () => {
    ...
    describe('without selector', () => {
        it('must emit unique values', () => {
            ...
            const output = pipeSync(input, distinct());
        ...
        it('must emit repeated objects', () => {
            ...
            const output = pipeSync(objects, distinct());
    ...
    describe('with selector', () => {
        ...
        it('must ignore invalid selectors', () => {
            const output = pipeSync([1, 1, 2, 2], distinct('bla' as any));
