...
export default () => {
    describe('with iterators', () => {
        it('must support sync ones', async () => {
            ...
            const result = pipeAsync([], concat(input));
